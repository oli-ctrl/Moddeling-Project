...
public static class UITools
{
    ...
    public static void ChangedColor(ref Color color, string text, Action<Color> changedAction)
    {
        var newColor = EditorGUILayout.ColorField(text, color);
        if (newColor != color)
        {
            changedAction.Invoke(newColor);
        }
